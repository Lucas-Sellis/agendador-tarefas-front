    ...
    dialogRef.afterClosed().subscribe(result => {
      if (result) {
        ...
        this.tasksService.createTask(payload).subscribe({
          next: () => console.log('Tarefa cadastrada com sucesso', payload), //TODO: add toast
          error: () => console.log('Erro ao cadastrar a tarefa', payload), //TODO: add toast
        })
      }
    });
  }
    ...
    dialogRef.afterClosed().subscribe(result => {
      if (result) {
        ...
        this.tasksService.editTask(tarefa.id, payload).subscribe({
          ...
          error: () => console.log('Erro ao editar a tarefa', payload), //TODO: add toast
        })
      }
    });
  }
    ...
    dialogRef.afterClosed().subscribe(result => {
      if (result) {
        ...
        this.tasksService.deletarTask(tarefa).subscribe({
          next: () => console.log('Tarefa excluída com sucesso'), //TODO: add toast
          error: () => console.log('Erro ao excluir a tarefa'), //TODO: add toast
        })
      }
    });
  }
